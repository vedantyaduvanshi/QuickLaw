        ...
        <div className="container px-10 py-10 mx-auto">
          <div className="text-center mb-20">
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 font-bold mx-auto text-indigo-700 mb-4">
              Hassle-Free Bail Application Process
            </p>
            ...
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 font-semibold mx-auto text-gray-500s">
              Submit your bail application effortlessly
            </p>
          ...
          <div className="flex  justify-center gap-8">
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center bg-white border rounded shadow-xl">
              ...
              <div className="flex-grow">
                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">
                  In-house Bail Processing
                </h2>
                <p className="leading-relaxed text-base">
                  Quick and easy bail processing with minimal delays.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center bg-white border rounded shadow-xl">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">
                  Call us at +91 93283-35163/ +91 85114-412354 to clear your
                  queries.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center bg-white border rounded shadow-xl">
              ...
              <div className="flex-grow">
                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">
                  Instant Bail Approval
                </h2>
                <p className="leading-relaxed text-base">
                  90% of bail applications processed within 2 hours.
                </p>
              </div>
            </div>
          </div>
