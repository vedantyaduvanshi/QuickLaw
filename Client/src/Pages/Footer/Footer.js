...
import logo from "../../image/logo (2).png"; //Health-Insurance\Client\src\image\logo (2).png
        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 text-body-color">
                  Safeguarding your rights and peace of mind, one justice policy
                  at a time.
                </p>
            ...
            <LinkGroup header="Resources">
              ...
              <NavLink link="/#" label="National Portal" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} Team Wolves{" "}
                </p>
              </div>
            </div>
          </div>
