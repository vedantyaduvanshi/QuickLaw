  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          1. If you have any queries or need assistance with the bail process, our
          helpdesk is available to support you. Please reach out to the helpline
          number for your respective jurisdiction.
        </p>
        <p>
          2. Our experienced representatives will guide you through the bail
          process, provide you with the necessary information, and address any
          concerns you may have regarding your bail application.
        </p>
        <p>
          3. For urgent matters or emergencies, kindly dial our 24/7 helpline
          number for immediate assistance and support with your bail process.
        </p>
        <p>
          4. Thank you for choosing the Bail Reckoner system. We are committed to
          ensuring a seamless and hassle-free bail process for you.
        </p>
      </div>
    </div>
  );
